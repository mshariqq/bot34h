## Bot34h is basically, a bot that will write an entire project by creating new files and new lines of code by reading an existing project.

So, it does this job "A human can take 1 or 2 weeks to replicate a project by reading an existing project files and code", so this bot can do the job in minutes.
